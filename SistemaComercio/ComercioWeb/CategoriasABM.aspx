<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoriasABM.aspx.cs" Inherits="ComercioWeb.CategoriasABM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card">
        ...
        <div class="actions">
            <asp:Button ID="btnGuardar" runat="server" Text="Guardar categoria" CssClass="btn btn-primary" OnClick="btnGuardar_Click" />
