<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ComprasABM.aspx.cs" Inherits="ComercioWeb.ComprasABM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-title">
        <h1>Compras</h1>
        <p>Registro de nueva compra a proveedor.</p>
    </div>
    ...
    <div class="form-group" style="justify-content: flex-end;">
        ...
        <asp:GridView ID="dgvCarrito" runat="server" AutoGenerateColumns="False" CssClass="table" OnRowCommand="dgvCarrito_RowCommand" ShowHeaderWhenEmpty="true">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Proveedores">
                    <ItemTemplate>
                        <asp:Label runat="server" Text='<%# ObtenerNombresProveedores((System.Collections.Generic.List<Dominio.Proveedor>)Eval("Producto.Proveedores")) %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:ButtonField CommandName="Quitar" Text="Quitar" ControlStyle-CssClass="btn btn-danger" HeaderText="Accion" />
            </Columns>
        </asp:GridView>
        ...
        <div class="actions">
            <asp:Button ID="btnGuardar" runat="server" Text="Registrar compra completa" CssClass="btn btn-primary" OnClick="btnGuardar_Click" />
